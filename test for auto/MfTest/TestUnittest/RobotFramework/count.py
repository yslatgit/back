...
class BaiduSearchTest:
    ...
    def open_browsers(self):        
        test_01 = self.suite.tests.create(u"启动浏览器")
    ...
    def close_browsers(self):
        test_04 = self.suite.tests.create(u"关闭浏览器")
    ...
    def run(self):
        ...
        # 运行套件
        result = self.suite.run(critical=u"百度搜索",
            output="output.xml")
...
if __name__ == "__main__":
    print(u"用Python写Robot Framework测试")
    suite = BaiduSearchTest(u"百度搜索测试套件")
    suite.run()